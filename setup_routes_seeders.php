...
PHP;
writeFileSafe(__DIR__ . '/routes/web.php', $routes);
...
PHP;
writeFileSafe(__DIR__ . '/database/seeders/DatabaseSeeder.php', $seeder);

echo "Routes and DatabaseSeeder configured successfully.\n";
